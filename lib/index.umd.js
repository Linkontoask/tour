(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.Tour = factory());
  ...
  */
  ...
  var Tour = /*#__PURE__*/function () {
    function Tour() {
      ...
      this.steps = [];
      this.doc = document;
      this.options = merge$1(cloneDeep(defaultOptions), options);
      this.cache = {
        tourContainer: null,
    ...
    _createClass(Tour, [{
      ...
      value: function setOptions(options) {
        this.options = merge$1(cloneDeep(this.options), options);
      }
    }, {
      key: "show",
      value: function show() {
      ...
      value: function _createElement(children, _ref) {
        ...
        if (dataset) {
          merge$1(div.dataset, dataset);
        }

        if (style && _typeof(style) === 'object') {
          merge$1(div.style, style);
        }
      ...
      value: function _render() {
        ...
        if (step) {
          ...
          var popper = createPopper(contentContainer, contentElement, merge$1({
            placement: 'auto',
            modifiers: [{
              name: 'offset',
              options: {
